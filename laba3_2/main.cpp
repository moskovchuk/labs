...
const char* MENU[]{ "1. Create an empty set of char.", "2. Create a set of char (power is known)", "3. Create a set of char (string of symbols is known)", "4. Show set of char", "5. Union of two sets", "6. Adding a new element to the set", "7. Intersection of two sets", "8. Subtraction of two sets", "9. Element search in set", "10.Enter from input stream", "0. Exit" };
    ...
    do
    {
        ...
        switch (menu)
        {
            ...
            case 6:
                ...
                cin.get(symbol);//˜ÚÓ·˚ Ò˜ËÚ‡Ú¸ enter ÔÓÒÎÂ ‚‚Ó‰‡
                cin.get(symbol);
                s += symbol;
                break;
            case 7:
            ...
            case 9:
                ...
                cin.get(d);//˜ÚÓ·˚ Ò˜ËÚ‡Ú¸ enter ÔÓÒÎÂ ‚‚Ó‰‡
                cin.get(d);
                if (s == (d) == true)
            ...
            case 10:
                std::cin.clear();
                std::cout << "Enter new string of char (max power is " << s.getMP() << "):" << std::endl;
                try {
                    std::cin >> s;
                    std::cout << s;
                }
